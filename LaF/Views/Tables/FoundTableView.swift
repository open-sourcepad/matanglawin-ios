...
class FoundTableView: UIView, UITableViewDelegate, UITableViewDataSource, PostCellDelegate  {
    ...
    func getPost() {
        Alamofire.request(.GET, Constants.API.found, headers:
...
@objc protocol FoundTableViewDelegate {
    optional func foundTablePostCell(tableView: FoundTableView, postCellDidTap sender: AnyObject)
}